...
class Robot:
    def __init__(self, name: str, color_code: str):
        ...
        self.energy = 100
        self.parts = [
            PartRobot("Head", attack_level=5, defense_level=10, energy_consumption=5),
            PartRobot("Weapon", attack_level=15, defense_level=0, energy_consumption=10),
            PartRobot("Left Arm", attack_level=3, defense_level=20, energy_consumption=10),
            PartRobot("Right Arm", attack_level=6, defense_level=20, energy_consumption=10),
            PartRobot("Left Leg", attack_level=4, defense_level=20, energy_consumption=15),
            PartRobot("Right Leg", attack_level=8, defense_level=20, energy_consumption=15),
        ]
    def greet(self):
